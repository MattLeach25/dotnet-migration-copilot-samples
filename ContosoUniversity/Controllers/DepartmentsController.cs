        ...
        public IActionResult Edit([Bind("DepartmentID,Name,Budget,StartDate,InstructorID,RowVersion")] Department department)
        {
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, "The record you attempted to edit was modified by another user. The edit operation was canceled and the current values have been displayed. If you still want to edit this record, click the Save button again.");
