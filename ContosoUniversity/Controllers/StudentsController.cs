...
namespace ContosoUniversity.Controllers
{
    public class StudentsController : BaseController
    {
        ...
        public IActionResult Create([Bind("LastName,FirstMidName,EnrollmentDate")] Student student)
        {
            ...
            {
                System.Diagnostics.Trace.TraceError($"Error creating student: {ex.Message}");
        ...
        public IActionResult Edit([Bind("ID,LastName,FirstMidName,EnrollmentDate")] Student student)
        {
            ...
            {
                System.Diagnostics.Trace.TraceError($"Error editing student: {ex.Message}");
                ModelState.AddModelError("", "Unable to save changes. Try again, and if the problem persists see your system administrator.");
            }
            return View(student);
        }
        ...
        public IActionResult DeleteConfirmed(int id)
        {
            ...
            {
                System.Diagnostics.Trace.TraceError($"Error deleting student: {ex.Message}");
